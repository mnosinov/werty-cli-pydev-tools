...
let s:bwc.DarkGreen = ['008000', 2] 	"TODO adjust variations: 2(tty), 35(gui)
let s:bwc.Blue = ['0000ff', 12] 
let s:bwc.Lime = ['00ff00', 10] 
let s:bwc.Yellow = ['ffff00', 'Yellow'] 
let s:bwc.Maroon = ['800000', 124]	"TODO adjust variations: 124(tty), 160(gui)
let s:bwc.Orange = ['008000', 142]	"TODO adjust variations: 142(tty), 214(gui)
let s:bwc.White = ['ffffff', 15]
let s:bwc.DarkCyan = ['ffff0f', 6]	"TODO adjust variations: 6(tty), 39(gui)
...
call s:HL('MatchParen', 'Red', 'White', 'bold', '')
