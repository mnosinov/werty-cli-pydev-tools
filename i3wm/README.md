...
$mod - Either Windows key or Alt (I prefer binding it to Windows key)
...
You can run any sh script in a new window using: ```i3-msg 'exec path/to/script.sh'```  
e.g.: ```i3-msg 'exec /home/user/pycharm-community-2021.3.3/bin/pycharm.sh'```
