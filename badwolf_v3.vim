...
let s:N3 = [ '#8cffba' , '#242321' , yellow , purple ] " saltwatertaffy & darkgravel
let s:N4 = [ '#666462' , 241 ]                   " mediumgravel

let s:I1 = [ '#141413' , '#0a9dff' , yellow , lightgreen  ] " blackestgravel & tardis
let s:I2 = [ '#f4cf86' , '#005fff' , 7 , purple  ] " dirtyblonde    & facebook
let s:I3 = [ '#0a9dff' , '#242321' , yellow  , purple ] " tardis         & darkgravel

let s:V1 = [ '#141413' , '#ffa724' , 14 , purple ] " blackestgravel & orange
let s:V2 = [ '#000000' , '#fade3e' , 7 , purple ] " coal           & dalespale
let s:V3 = [ '#000000' , '#b88853' , yellow , purple ] " coal           & toffee
