...
let s:N2 = [ '#f4cf86' , '#45413b' , 3 , 238 ] " dirtyblonde    & deepgravel
let s:N3 = [ '#8cffba' , '#242321' , 121 , 235 ] " saltwatertaffy & darkgravel
let s:N4 = [ '#666462' , 241 ]                   " mediumgravel

let s:I1 = [ '#141413' , '#0a9dff' , 232 , 10  ] " blackestgravel & tardis
let s:I2 = [ '#f4cf86' , '#005fff' , 3 , 238  ] " dirtyblonde    & facebook
let s:I3 = [ '#0a9dff' , '#242321' , 121  , 235 ] " tardis         & darkgravel

let s:V1 = [ '#141413' , '#ffa724' , 232 , 182 ] " blackestgravel & orange
let s:V2 = [ '#000000' , '#fade3e' , 3 , 238 ] " coal           & dalespale
let s:V3 = [ '#000000' , '#b88853' , 121 , 235 ] " coal           & toffee
